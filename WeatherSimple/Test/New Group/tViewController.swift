...
class tViewController: DemoBaseViewController {
    ...
    let chartView = CombinedChartView(frame: CGRect(x: 0, y: 0, width: 400, height: 400))
...
extension tViewController: AxisValueFormatter {
